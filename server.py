...
@app.route('/quiz/iso')
def quiz_iso():
    return render_template('quiz_iso.html')

@app.route('/quiz/shutter')
def quiz_shutter():
    return render_template('quiz_shutter.html')

@app.route('/quiz/aperture')
def quiz_aperture():
    return render_template('quiz_aperture.html')

@app.route('/quiz/camera')
def quiz_camera():
